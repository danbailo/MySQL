...
#ORDEM PARA EXCLUSAO, POR CAUSA DE DEPENDENCIA
DROP TABLE ENDERECO;
DROP TABLE TELEFONE;
DROP TABLE CLIENTE;
...
CREATE TABLE TELEFONE(
	...
	ID_CLIENTE INT #UNIQUE = 1x1, SEM UNIQUE, 1xN 
);

ALTER TABLE CLIENTE ADD CONSTRAINT PK_CLIENTE
PRIMARY KEY(IDCLIENTE);

ALTER TABLE TELEFONE ADD CONSTRAINT FK_CLIENTE_TELEFONE #CONVENCIONADO DA SEGUINTE FORMA, TIPOKEY_ONDEVEM_ONDEESTA
...
mysql
performance_schema
*/ -- PERTENCE AO DICIONARIO
--qqr objeto de qqr banco vc ira encontrar nesses bancos/tabelas	 

STATUS

#PROCURANDO NO DICIONARIO DE DADOS;
...
+----------+---------------------+------------+-------------+
| BANCO    | NOME                | TABELA     | TIPO        |
+----------+---------------------+------------+-------------+
| COMERCIO | PRIMARY             | CLIENTE    | PRIMARY KEY |
| COMERCIO | PRIMARY             | CURSOS     | PRIMARY KEY |
| COMERCIO | PRIMARY             | JOGADOR    | PRIMARY KEY |
...
| COMERCIO | PRIMARY             | TIMES      | PRIMARY KEY |
| COMERCIO | TIMES_ibfk_1        | TIMES      | FOREIGN KEY |
...
SELECT CONSTRAINT_SCHEMA AS "BANCO",
	   ...
	   CONSTRAINT_TYPE "TIPO"
	   FROM TABLE_CONSTRAINTS
	   WHERE CONSTRAINT_SCHEMA = "COMERCIO" AND 
	   TABLE_NAME = "CLIENTE" OR TABLE_NAME = "TELEFONE";
+----------+---------------------+----------+-------------+
| BANCO    | NOME                | TABELA   | TIPO        |
+----------+---------------------+----------+-------------+
| COMERCIO | PRIMARY             | CLIENTE  | PRIMARY KEY |
...
#ISSO E EFICIENTE QUANDO EU FOR FAZER ARMAZENAMENTO EM MASSA, EX: 1000000 DE REGISTROS QUE JA RESPEITAM
#A MINHA REGRA, SE ELA ESTIVER HABILITADA, OS REGISTROS SERAO VERIFICADOS 1 A 1, LOGO, EU DESABILITO,
#ADICIONO TUDO, E DPOIS REATIVO A RESTRICAO
